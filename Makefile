#############################################################################
# Makefile for building: mdma
# Generated by qmake (3.1) (Qt 5.9.1)
# Project:  mdma.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile mdma.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_DEPRECATED_WARNINGS -DQT -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
COMPRESS      = gzip -9f
DISTNAME      = mdma1.0.0
DISTDIR = /home/jalon/src/github/mw-mdma-cli/.tmp/mdma1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now
LIBS          = $(SUBLIBS) -lusb-1.0 -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: mdma.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents flashdlg.h commands.h esp-prog.h mdma.h progbar.h flash_man.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp flashdlg.cpp commands.c esp-prog.c mdma.c progbar.c flash_man.cpp $(DISTDIR)/
...
commands.o: commands.c commands.h \
		util.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o commands.o commands.c

esp-prog.o: esp-prog.c esp-prog.h \
		commands.h \
		util.h \
		progbar.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o esp-prog.o esp-prog.c

mdma.o: mdma.c mdma.h \
		util.h \
		commands.h \
		progbar.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o mdma.o mdma.c

progbar.o: progbar.c progbar.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o progbar.o progbar.c

flash_man.o: flash_man.cpp flash_man.h \
		util.h \
		commands.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o flash_man.o flash_man.cpp
